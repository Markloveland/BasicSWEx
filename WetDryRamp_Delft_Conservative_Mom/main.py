...
#Q_flux =   as_vector((h_wd,u[1],u[2]))
Qn     =   as_vector((h_n_wd, h_wd*u_n[1], h_wd*u_n[2]))
Qn_old =   as_vector((h_n_old_wd, h_wd*u_n_old[1], h_wd*u_n_old[2] )) 
...
eta = h-h_b
g_vec = as_vector((0,
 					-ux*(qx.dx(0) + qy.dx(1)) - eta*g*h_b_wd.dx(0),
 					-uy*(qx.dx(0) + qy.dx(1)) - eta*g*h_b_wd.dx(1)))
